...
# 8. GUARDARDADO
os.makedirs(f"../../models/v2/lstm/{SEED}/", exist_ok=True)
model.save(f"../../models/v2/lstm/{SEED}/lstm_model_v2.keras")
joblib.dump(scaler_target, f"../../models/v2/lstm/{SEED}/scaler_target_lstm_v2.pkl")
joblib.dump(scaler_features, f"../../models/v2/lstm/{SEED}/scaler_features_lstm_v2.pkl")
print("\nModelo LSTM y scalers guardados")
...
mae_v1, rmse_v1, mape_v1 = 56.3, 67.0, 5.23

print("\n" + "="*58)
print(f"{'Métrica':<10} {'LSTM v1':>10} {'LSTM v2':>10} {'Naive':>12}")
print("="*58)
...
axes[0].set_title("LSTM v2 — Curva de aprendizaje")
...
axes[1].plot(test_index, y_pred_real[:n_plot], label="LSTM v2", linestyle="--")
axes[1].plot(test_index, y_naive_real[:n_plot], label="Naive (t-168)", alpha=0.6)
axes[1].set_title("LSTM v2 — Predicción primera semana del test")
...
plt.tight_layout()
plt.savefig(f"../../models/v2/lstm/{SEED}/prediction_lstm_v2.png", dpi=150)
plt.show()
