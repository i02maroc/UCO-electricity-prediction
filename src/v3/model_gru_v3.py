...
# 8. GUARDARDADO
os.makedirs(f"../../models/v3/gru/{SEED}/", exist_ok=True)
model.save(f"../../models/v3/gru/{SEED}/gru_model_v3.keras")
joblib.dump(scaler_target, f"../../models/v3/gru/{SEED}/scaler_target_gru_v3.pkl")
joblib.dump(scaler_features, f"../../models/v3/gru/{SEED}/scaler_features_gru_v3.pkl")
...
print("\n" + "="*65)
print(f"{'Métrica':<10} {'gru v1':>10} {'gru v2':>10} {'gru v3':>10} {'Naive':>10}")
print("="*65)
...
axes[0].set_title("gru v3 — Curva de aprendizaje")
...
axes[1].plot(test_index, y_pred_real[:n_plot], label="gru v3", linestyle="--")
axes[1].plot(test_index, y_naive_real[:n_plot], label="Naive (t-168)", alpha=0.6)
axes[1].set_title("gru v3 — Predicción primera semana del test")
...
plt.tight_layout()
plt.savefig(f"../../models/v3/gru/{SEED}/prediction_gru_v3.png", dpi=150)
plt.show()
