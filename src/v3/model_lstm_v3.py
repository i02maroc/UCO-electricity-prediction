...
print(f"\nNaN en temperatura: {df['temp'].isna().sum()}")
...
print(f"NaN totales en dataset: {data.isna().sum().sum()}")
...
# 8. GUARDARDADO
os.makedirs(f"../../models/v3/lstm/{SEED}/", exist_ok=True)
model.save(f"../../models/v3/lstm/{SEED}/lstm_model_v3.keras")
joblib.dump(scaler_target, f"../../models/v3/lstm/{SEED}/scaler_target_lstm_v3.pkl")
joblib.dump(scaler_features, f"../../models/v3/lstm/{SEED}/scaler_features_lstm_v3.pkl")
...
mae_v3 = mean_absolute_error(y_test_real, y_pred_real)
rmse_v3 = np.sqrt(mean_squared_error(y_test_real, y_pred_real))
mape_v3 = mape(y_test_real, y_pred_real)
...
mae_v1, rmse_v1, mape_v1 = 50.1, 66.1, 4.64
mae_v2, rmse_v2, mape_v2 = 52.2, 65.7, 4.83

print("\n" + "="*65)
print(f"{'Métrica':<10} {'LSTM v1':>10} {'LSTM v2':>10} {'LSTM v3':>10} {'Naive':>10}")
print("="*65)
print(f"{'MAE':<10} {mae_v1:>10.1f} {mae_v2:>10.1f} {mae_v3:>10.1f} {mae_naive:>10.1f}")
print(f"{'RMSE':<10} {rmse_v1:>10.1f} {rmse_v2:>10.1f} {rmse_v3:>10.1f} {rmse_naive:>10.1f}")
print(f"{'MAPE':<10} {mape_v1:>9.2f}% {mape_v2:>9.2f}% {mape_v3:>9.2f}% {mape_naive:>9.2f}%")
print("="*65)
...
axes[0].set_title("LSTM v3 — Curva de aprendizaje")
...
axes[1].plot(test_index, y_pred_real[:n_plot], label="LSTM v3", linestyle="--")
axes[1].plot(test_index, y_naive_real[:n_plot], label="Naive (t-168)", alpha=0.6)
axes[1].set_title("LSTM v3 — Predicción primera semana del test")
...
plt.tight_layout()
plt.savefig(f"../../models/v3/lstm/{SEED}/prediction_lstm_v3.png", dpi=150)
plt.show()
